      ...
      <div className={styles.legend}>
        {[
          ...
          <span key={era.key} className={styles.legendItem}>
            <span className={styles.legendDot} style={{ background: ERA_COLORS[(era as any).key as keyof typeof ERA_COLORS] }} />
            {era.label}
          </span>
        ))}
      </div>
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  borderColor: ERA_COLORS[(event as any).era as keyof typeof ERA_COLORS],
                  boxShadow: isVisible ? `0 0 12px ${ERA_COLORS[(event as any).era as keyof typeof ERA_COLORS]}40` : "none",
                }}
              >
                <div className={styles.nodeInner} style={{ background: ERA_COLORS[(event as any).era as keyof typeof ERA_COLORS] }} />
              </div>
              <div className={styles.card}>
                <span className={styles.cardYear} style={{ color: ERA_COLORS[(event as any).era as keyof typeof ERA_COLORS] }}>
                  {event.year}
                </span>
